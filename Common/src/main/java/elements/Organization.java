...
public class Organization implements Comparable<Organization>, Serializable {
    ...
    public Organization(Long id, String name, Coordinates coordinates, Integer annualTurnover, int employeesCount, OrganizationType type, Address officialAddress) throws ElementConstructorException {
        setId(id);
        setName(name);
